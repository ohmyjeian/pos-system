            ...
            clearAllData() {
                if (confirm('Are you sure you want to clear all data? This action cannot be undone.')) {
                    try {
                        ...
                        state.chefs = [];
                        state.stations = [];
                        state.recipeCategories = ['Coffee', 'Frappe', 'Dairy Drinks', 'Matcha Series', 'Soda Refreshers', 'Short Order', 'Silog', 'Pasta & Noodles', 'Pancakes', 'Lomi', 'Burger & Sandwiches', 'Finger Food', 'Extras'];
                        state.inventory = [];
                        state.suppliers = [];
                        state.purchases = [];
                        state.waste = [];
