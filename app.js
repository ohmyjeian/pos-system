document.addEventListener('alpine:init', () => {
    Alpine.data('app', () => ({
        ...
        settings: {
            ...
            deliveryFee: 50,
            currency: 'PHP',
            restaurantName: 'Blessed Cafe',
            address: 'Sto. Nino Meycauayan, Bulacan',
            phone: '0976 124 8441',
            email: '',
            website: 'https://www.facebook.com/profile.php?id=61576756904878',
        ...
        recipeCategories: ['Coffee', 'Frappe', 'Dairy Drinks', 'Matcha Series', 'Soda Refreshers', 'Short Order', 'Silog', 'Pasta & Noodles', 'Pancakes', 'Lomi', 'Burger & Sandwiches', 'Finger Food', 'Extras'],
